...
class MenuApp(tk.Tk):
    def __init__(self, menu_items):
        ...
        self.menu_frame = tk.Frame(self, bg='white', padx=self.spacing, pady=self.spacing)
